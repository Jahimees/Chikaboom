    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createIncomeAppointmentModalLabel">Создать запись</h5>
            ...
            <div id="appointment-fields" class="modal-body">
                <div>Клиент</div>
                <select class="middle-box w-80" style="display: block" id="client-select-app"></select>
                <div>Услуга</div>
