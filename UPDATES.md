...
## Обновление V0.3.2-BETA (в разработке)
* Починен REST-API, обновлена документация
* Создана прослойка между сервисами и контроллерами (в разработке)
* Добавлен раздел "Галерея" (в разработке)
