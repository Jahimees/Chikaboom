...
* Обновление Analytics update (в разработке)
* Обновление Communication update (в разработке)
* Обновленная документация REST-API (в разработке)

## Обновление V0.3.4-BETA (Communication update) (в разработке)
* Добавлена возможность ставить оценки и оставлять комментарии (в разработке)
* Добавлен онлайн-чат между клиентами и мастерами (в разработке)
* Добавлены уведомления (в разработке)
* Добавлен раздел "Избранное" (в разработке)

## Обновление V0.3.3-BETA (Analytics update) (в разработке)
...
* Исправлен баг с невозможностью авторизации со страницы поиска (в разработке)
